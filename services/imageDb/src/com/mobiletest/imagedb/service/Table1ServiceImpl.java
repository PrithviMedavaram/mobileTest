...
import com.mobiletest.imagedb.*;


/**
 * ServiceImpl object for domain model class Table1.
 * @see com.mobiletest.imagedb.Table1
 */
@Service("imageDb.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    public void setWMGenericDao(WMGenericDao<Table1, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "imageDbTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "imageDbTransactionManager")
    @Override
